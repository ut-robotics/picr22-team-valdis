...
=== Friday 2022-12-23
*Arnold:* Worked on more siftware and debugging bad connection between the mainboard and the IDE (4h)
*Kevin:* Worked on more siftware and debugging bad connection between the mainboard and the IDE (4h)
