...
This board should be fine to operate any 12V motor with a power output that exceeds 3.2A. For our general purpose we used 12V Pololu motors with a stall current of 5.5A @ 12W. It is also important to use motors with encoders, otherwise the firmware won't work properly.
